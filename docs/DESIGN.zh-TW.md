...
- 到達掩體後，CoHero 暫時不使用自己的遠程武器破壞誘敵策略，而是等待敵人靠近；敵人重新進入視野且一個安全移動步即可建立近戰時，立即貼身。目標完全離開 CoHero 視野時不讀取其牆後新座標，只在既定 cover 最多等待 6 回合；逾時即放棄該 plan，避免永久卡住。低血撤退、立即致命風險、hazard avoidance 與出口集合都可中止此 tactic。
